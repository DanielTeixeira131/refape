...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="home.php"><span>Refape</span></a></h1>
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      ...
      <h2>O melhor serviço de reconhecimento facial</h2>
    </div>
  </section>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        <div class="section-title" data-aos="fade-in" data-aos-delay="100">
          ...
          <p>Primeiramente, cadastre os funcionários. Após isso, clique no botão de reconhecimento facial.</p>
        </div>
      </div>
